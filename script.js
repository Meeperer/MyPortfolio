 ...
 * 
 * A modern, elegant portfolio website built with vanilla JavaScript.
 * Features custom cursor, magnetic buttons, scroll animations, and more.
 */
...
class CustomCursor {
    ...
    addHoverListeners() {
        const hoverElements = document.querySelectorAll(
            'a, button, .magnetic-btn, .project-card'
        );
    ...
    animate() {
        // Smooth interpolation for dot (faster response)
...
class ScrollReveal {
    constructor() {
        this.revealElements = document.querySelectorAll(
            '.reveal-text, .reveal-fade, .reveal-image, .reveal-project'
        );
        this.init();
    }
...
// ============================================================================
// TEXT SCRAMBLE EFFECT (Optional - Currently Unused)
// ============================================================================
...
class LoadingAnimation {
    ...
    init() {
        ...
        window.addEventListener('load', () => {
            ...
            // Trigger initial reveals with staggered timing
            setTimeout(() => {
...
class ProjectCarousel {
    ...
    init() {
        this.carousels.forEach((carousel) => {
            ...
            const prevArrow = carousel.parentElement.querySelector(
                '.carousel-arrow-prev'
            );
            const nextArrow = carousel.parentElement.querySelector(
                '.carousel-arrow-next'
            );
            let currentIndex = 0;
            ...
            const navigate = (direction) => {
                ...
                do {
                    nextIndex =
                        (nextIndex + direction + images.length) % images.length;
                    attempts++;
                } while (
                    images[nextIndex].style.display === 'none' &&
...
class DarkModeToggle {
    constructor() {
        ...
        this.label = this.toggle
            ? this.toggle.querySelector('.theme-label')
            : null;
